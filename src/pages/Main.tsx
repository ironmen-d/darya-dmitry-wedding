...
const Main = () => {
  ...
  const colorPalette = [
    { color: '#FDE1D3', name: 'Персиковый' },
    { color: '#FFDEE2', name: 'Пыльно-розовый' },
    { color: '#E07A5F', name: 'Терракотовый' },
    { color: '#CDDEEE', name: 'Серо-голубой' },
    { color: '#D1E8E2', name: 'Мятный' },
    { color: '#8B5E3C', name: 'Коричневый' },
  ];
  ...
  return (
    <div className="main-container bg-gradient-to-b from-white to-wedding-blue-gray/10">
            ...
            <div className="bg-white bg-opacity-80 rounded-lg shadow-md p-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a 
                    href="https://maps.google.com/?q=Дворец+бракосочетания+№4,+г.+Москва,+Бутырская+улица,+17" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="inline-block mt-3 text-sm text-wedding-terracotta hover:underline"
                  >
                    Посмотреть на карте
                  </a>
                </div>
            ...
            <div className="bg-white bg-opacity-80 rounded-lg shadow-md p-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a 
                    href="https://maps.google.com/?q=Loft+House,+г.+Красногорск,+улица+Согласия,+13" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="inline-block mt-3 text-sm text-wedding-terracotta hover:underline"
                  >
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {colorPalette.map((color, index) => (
              <div key={index} className="text-center">
                <div className="heart-shape" style={{ transform: 'rotate(45deg)' }}>
                  <div 
                    style={{ 
      ...
      <section id="contacts" className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl mb-8">
            Дарья и Дмитрий - +79091633036 и +79067250565
          </p>
          
          <div className="flex flex-col md:flex-row justify-center gap-4 mt-6">
            <a 
              href="https://wa.me/79091633036" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-md transition-colors inline-flex items-center justify-center"
            >
              Написать в WhatsApp
            </a>
            <a 
              href="https://t.me/+79091633036" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-md transition-colors inline-flex items-center justify-center"
            >
              Написать в Telegram
            </a>
          </div>
